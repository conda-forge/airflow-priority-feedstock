About airflow-priority-feedstock
================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/airflow-priority-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/airflow-priority-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add airflow-priority
# for installing globally
pixi global install airflow-priority
```
...
It is possible to list all of the versions of `airflow-priority` available on your platform:
...
```
pixi search airflow-priority --channel conda-forge
```
